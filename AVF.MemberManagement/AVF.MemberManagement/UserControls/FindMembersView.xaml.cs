...
namespace AVF.MemberManagement.UserControls
{
    ...
    public partial class FindMembersView : ContentView
    {
        ...
        {
            (BindingContext as FindMembersViewModelBase)?.AddFoundMemberCommand?.Execute(null);
        }

        void Handle_Completed(object sender, System.EventArgs e)
        {
            (BindingContext as FindMembersViewModelBase)?.AddAndClearSearchTextCommand?.Execute(null);
